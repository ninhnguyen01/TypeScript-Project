...
const fruits3 = ["apple", "banana", "orange", "mango", "kiwi"];
const [...rest] = fruits3;

console.log(rest); // ['apple', 'banana', 'orange', 'mango', 'kiwi']
...
*/
const desserts2 = ["cake", "cookies", "pie"];
desserts2.pop();

console.log(desserts2); // ["cake", "cookies"];

/*
shift() Method: This method is used to remove the first element from an array and return that removed element. 
If the array is empty, then the return value will be undefined.
*/
const desserts3 = ["cake", "cookies", "pie"];
desserts3.shift();

console.log(desserts3); // ["cookies", "pie"];

/*
unshift() Method: This method is used to add elements to the beginning of the array and will return the new length.
*/

const desserts4 = ["cake", "cookies", "pie"];
desserts4.unshift("ice cream");

console.log(desserts4); // ["ice cream", "cake", "cookies", "pie"];
...
const index = fruits4.indexOf("banana");

console.log(index); // 1
console.log(fruits4.indexOf("not found")); // -1
...
The first argument specifies the index at which to begin modifying the array. 
The second argument are the number of elements you wish to remove. 
...
console.log(colors2); // ["red", "yellow", "purple", "green", "blue"]
...
const programmingLanguages2 = ["JavaScript", "Python", "C++"];
const newList = programmingLanguages2.concat("Perl");
...
const programmingLanguages3 = ["JavaScript", "Python", "C++"];
const newList2 = programmingLanguages3.slice(1);

console.log(newList2); // ["Python", "C++"]
...
*/
const desserts5 = ["cake", "cookies", "pie"];
console.log(desserts5.reverse()); // ["pie", "cookies", "cake"]
