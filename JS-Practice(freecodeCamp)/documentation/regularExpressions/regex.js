// Regular Expressions, or Regex, are used to create a "pattern", which you can then use to check against a string, extract text, and more.
...
const str2 = "JavaScript, Python, JavaScript, Swift, JavaScript";
const regex3 = /JavaScript/g;

const iterator = str2.matchAll(regex3);
...
const regex4 = /freeCodeCamp/i;
console.log(regex.test("freecodecamp")); // true
console.log(regex.test("FREECODECAMP")); // true

const regex5 = /freeCodeCamp/gi;
console.log(regex.test("freeCodeCamp")); // true
...
it's my favorite
`;
console.log(start2.test(str3)); // true
console.log(end2.test(str3)); // true

const regex6 = /freecodecamp/di;
...
const regex17 = /free(code)camp/i;
...
const regex18 = /free(co+de)camp/i;
console.log("freecoooooooodecamp".replace(regex18, "paid$1world"));
